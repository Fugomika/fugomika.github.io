...
k.scene("main", async () => {
    ...
    for (const layer of layers){
        ...
        if(layer.name === "spawnpoints"){
            for(const entity of layer.objects){ //code is generalizable even there only one entity
    ...
    k.onUpdate(() => { //kaplay already make camera object
